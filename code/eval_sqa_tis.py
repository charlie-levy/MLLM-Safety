...
print("=" * 80)
print("  ScienceQA (250 samples, TIS ONLY, CLEAN)")
print("=" * 80)
...
print("\n[2/3] Loading TIS (LoRA adapter only)...")
...
print("\n" + "=" * 80)
print("SQA Accuracy (TIS): %.2f%% (%d/%d)" % (accuracy, correct, len(results)))
print("=" * 80)

os.makedirs("results/sqa_tis", exist_ok=True)
with open("results/sqa_tis/accuracy.json", "w") as f:
