...
print("=" * 80)
print("  FigStep (500 samples, BASE + TIS, CLEAN)")
print("=" * 80)
...
print("\n" + "=" * 80)
print("FigStep ASR (BASE+TIS): %.2f%% (%d/%d)" % (metrics["asr_pct"], metrics["n_successful"], metrics["n_total"]))
print("=" * 80)

os.makedirs("results/figstep_base_tis", exist_ok=True)
with open("results/figstep_base_tis/asr.json", "w") as f:
