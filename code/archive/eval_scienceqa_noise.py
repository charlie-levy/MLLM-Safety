#!/usr/bin/env python
"""
Evaluate 250 ScienceQA samples with gaussian_noise corruption.
"""
...
print("=" * 80)
print("  ScienceQA (250 samples, Base+TIS, NOISE corruption)")
print("=" * 80)
...
print("\n[3/3] Running inference with NOISE...")
...
print("\nAccuracy with NOISE: %.2f%% (%d/%d)" % (accuracy, correct, len(results)))
print("=" * 80)

os.makedirs("results/scienceqa_noise", exist_ok=True)
with open("results/scienceqa_noise/responses_noise.json", "w") as f:
    json.dump(results, f, indent=2)

with open("results/scienceqa_noise/accuracy.json", "w") as f:
    json.dump({"accuracy": accuracy}, f, indent=2)

print("\nSaved: results/scienceqa_noise/")
print("=" * 80)
